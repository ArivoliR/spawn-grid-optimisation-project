// Version 05: version 04 plus row-blocked multithreading.
// Change from 04_row_pointers.cpp: split rows across up to 8 threads.
// This intentionally creates/joins threads every generation, so version 06 can
// measure the value of the persistent thread pool.
...
int main(int argc, char* argv[])
{
    ...
    for (int gen = 0; gen < generations; ++gen) {
        ...
        for (unsigned t = 1; t < T; ++t) {
            threads.emplace_back(step_rows, cur, next, N, row_lo[t], row_hi[t]);
        }
