// Bitplane version 09: NEON block-H buffer with vertically sliding count.
//
// Representation:
...
// output rows.
//
// Compared to bitplane version 07, horizontal row sums for a block of rows are
// materialized into an L2-sized scratch buffer first. The vertical pass then
// sweeps the block using V[y+1] = V[y] - H[y-2] + H[y+3].
